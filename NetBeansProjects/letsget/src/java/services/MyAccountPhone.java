 ...
 * @author codar_000
 */
public class MyAccountPhone extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            db.updateUser(id, fN, lN, phone, email, type, code, active);
                    ...
                    request.getRequestDispatcher("my_accountPhone.jsp").forward(request, response);
        }

        response.sendRedirect("my_accountPhone.jsp");    
        out.close();
    }
