            ...
            <div>
                <form class="pure-form">
                    <fieldset class="pure-group">
                        <button type="submit" class="pure-button login pure-input-1 pure-button-primary">Subscribe</button>
                        <button type="submit" class="pure-button login pure-input-1 pure-button-primary">Unubscribe</button>
                    </fieldset>
                </form>
            </div>
    </div>
