 ...
 * @author codar_000
 */
public class MyAccountName extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            db.updateUser(id, fN, lN, phone, email, type, code, active);
                    ...
                    request.getRequestDispatcher("my_accountName.jsp").forward(request, response);
        }

        response.sendRedirect("my_accountName.jsp");    
        out.close();
    }
